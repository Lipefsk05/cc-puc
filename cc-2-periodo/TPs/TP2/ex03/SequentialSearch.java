...
public class SequentialSearch {
    ...
    static boolean findByName(String name, List<Pokemon> selectedPokemons) {
    ...
    public static void main(String[] args) {
        ...
        while (!(input = sc.nextLine()).equals(inputBreak)) {
            ...
            // String output = findByName(input, selectedPokemons) ? "SIM" : "NAO";
            // System.out.println(output);

            
            if(findByName(input, selectedPokemons))
