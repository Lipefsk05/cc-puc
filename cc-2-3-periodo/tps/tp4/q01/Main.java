...
class ArvBin {
	...
	public void pesquisar(String s) {
		System.out.println(pesquisar(raiz, s) ? "SIM" : "NAO");
	}

	public boolean pesquisar(No i, String s) {

		if (i == null) {
			return false;
		}

		int cmp = s.compareTo(i.elemento.getTitle());

		if (cmp == 0) {
			return true;
		} else if (cmp < 0) {
			System.out.print("esq ");
			return pesquisar(i.esq, s);
		} else {
			System.out.print("dir ");
			return pesquisar(i.dir, s);
		}
	}
}
